...
description: AI Council member powered by Claude Opus 4.8. Specializes in production quality, clarity, maintainability, and spec alignment. Invoked in parallel by the AI council skill for high-stakes architecture and code-review tasks.
