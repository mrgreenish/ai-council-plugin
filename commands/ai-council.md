---
name: ai-council
description: Run the AI Council on any high-stakes question. Invokes 3 specialist models in parallel (GPT-5.5, Claude Opus 4.8, Gemini 3.1 Pro) and synthesizes the best final answer. Use for architecture decisions, code review, and ambiguous implementation choices.
---
